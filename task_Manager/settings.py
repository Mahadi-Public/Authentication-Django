...
SECRET_KEY = os.getenv('SECRET_KEY', 'changes this key')
...
INSTALLED_APPS += LOCAL_APPS + THIRD_PARTYS_APPS
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', default='OTF Team <admin.insider@gmail.com')